...
export function getInt16 (buffer, offset) {
...
export function getInt32 (buffer, offset) {
...
export function getString (buffer, index, length) {
    let rawString;
...
export function getHexString (buffer, offset, length) {
...
export function setInt16(buffer, offset, value) {
    if ((buffer.length - offset) >= 2) {
...
export function setInt24(buffer, offset, value) {
...
export function setInt32(buffer, offset, value) {
    if ((buffer.length - offset) >= 4) {
        buffer[offset] = value & 0xFF;
        buffer[offset + 1] = (value >> 8) & 0xFF;
        buffer[offset + 2] = (value >> 16) & 0xFF;
...
export function setString(buffer, offset, length, data) {
    let i;
...
export function setHexString (buffer, offset, hexString) {
    let j=0;
