                    ...
                    serialPortPromises.push(
                        new Promise(function(resolve, reject) {
                            ...
                            let hdlc = new HDLC(function(payload) {
                                ...
                                if (payload.length === 6) {
                                    if (payload[0] == commands.GET_TYPE_VERSION_ACKNOWLEDGE
                            ...
                            serialPort.on('open', () => {
                                ...
                                command[0] = commands.GET_TYPE_VERSION;
                                bytes.setInt32(command, 1, 1);
                                serialPort.write(hdlc.createFrame(command, 5));
